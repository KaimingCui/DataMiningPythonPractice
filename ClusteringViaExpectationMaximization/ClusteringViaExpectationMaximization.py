...
for i in range(k):
	...
	print(np.around(means[index_incre[i]],decimals=3),file=f)
...
for i in range(k):
	...
	print('\n')
	print(np.around(final_covars[index_incre[i]], decimals = 3),file = f)
	print('\n',file=f)
...
print('\n')
print("-------------------------",file=f)
print("Iteration count = ",iteration,file=f)
print('\n',file=f)
...
print("-------------------------",file=f)
print("Cluster Membership:",file=f)
for i in range(k):
	...
	for j in range(len(final_clusters[index_incre[i]])):
		...
		print(np.array(final_clusters[index_incre[i]][j]),end = ",",file=f)
	print('\n')
	print('\n',file=f)
...
for i in  range(k):
	print(len(final_clusters[index_incre[i]]))
	print(len(final_clusters[index_incre[i]]),file=f)
