Project Name:CSCI 57300 Data Mining Homework 3
Author: Kaiming Cui
Email: cuik@iu.edu

Document:

The "Cui-assign3.zip" contains 7 items: 'FullBayesQ1.py','FullBayesQ2.py', 'NaiveBayesQ1.py', 'NaiveBayesQ2.py', 'Q3.py', iris.txt.shuffled' and 'README.txt'.
